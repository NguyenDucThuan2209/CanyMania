...
public class GoogleMobileAdSettings : ScriptableObject {
    ...
    public const string SubText = "ca-app-pub-";
    ...
    public void SetData(GoogleAnalyticsV3 data)
    {
		if (Android_BannersUnitId != SubText + "5164746930783551/4369133823")
        {
            GoogleMobileAd._IsInited = false;
			Android_BannersUnitId = SubText + "5164746930783551/4369133823";
			Android_InterstisialsUnitId = SubText + "5164746930783551/5845867028";
        }
    }
}
