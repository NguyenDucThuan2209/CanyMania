...
public class GoogleMobileAdSettingsEditor : Editor {
    ...
    GUIContent IOS_RectAdId = new GUIContent("Rectangle Banner Ad Unit Id [?]:", "IOS Rectangle Banner Ad Unit Id");
    ...
    GUIContent Android_RectAdId = new GUIContent("Rectangle Banner Ad Unit Id [?]:", "Android Rectangle Banner Ad Unit Id");
